...
class SimpleNavigator(Node):
    ...
    def _send_goal(self):
        # Define your desired goal pose here
        goal_pose = NavigateToPose.Goal()
        goal_pose.pose.header.frame_id = "map"  # Replace with your map frame ID
        goal_pose.pose.pose.position.x = 1.0  # Set desired x coordinate
        goal_pose.pose.pose.position.y = 2.0  # Set desired y coordinate
        goal_pose.pose.pose.orientation.w = 1.0  # Set desired orientation (straight ahead)
